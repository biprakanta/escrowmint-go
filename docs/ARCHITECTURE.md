...
Reclaim is intentionally bounded per call by an expiry sorted set scan, which avoids full reservation-hash walks on the hot path.
...
See [V2_ESCROW.md](/Users/biprakantapal/Desktop/codex-plugins/escrowmint-go/docs/V2_ESCROW.md).
