...
const commonLua = `local MAX_RECLAIM_BATCH = 128
...
const tryConsumeLua = commonLua + `local state_key = KEYS[1]
...
const topUpLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const reserveLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const commitLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const cancelLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const getStateLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const allocateChunkLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const consumeChunkLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const renewChunkLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const releaseChunkLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
...
const getChunkLua = commonLua + `local state_key = KEYS[1]
local reservations_key = KEYS[2]
local reservation_expiries_key = KEYS[3]
local chunk_leases_key = KEYS[4]
local chunk_expiries_key = KEYS[5]
